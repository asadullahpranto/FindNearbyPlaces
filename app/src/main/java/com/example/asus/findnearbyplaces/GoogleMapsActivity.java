...

{
    ...
    public void onClick(View v) {
        String hospital = "hospital", school = "school", restaurant = "restaurant", mosque = "mosque", market = "market";
...
//                                mMap.addMarker(userMarkerOptions);
            ...
            case R.id.mosque_nearby:
                mMap.clear();
                url = getUrl(latitide, longitude, mosque);
                transferData[0] = mMap;
                transferData[1] = url;
                getNearbyPlaces.execute(transferData);
                Toast.makeText(this, "searching nearby mosque", Toast.LENGTH_SHORT).show();
                Toast.makeText(this, "showing nearby mosque", Toast.LENGTH_SHORT).show();
                break;

            case R.id.market_nearby:
                mMap.clear();
                url = getUrl(latitide, longitude, market);
                transferData[0] = mMap;
                transferData[1] = url;
                getNearbyPlaces.execute(transferData);
                Toast.makeText(this, "searching nearby market", Toast.LENGTH_SHORT).show();
                Toast.makeText(this, "showing nearby market", Toast.LENGTH_SHORT).show();
                break;
        }
    }
    ...
    public void onBackPressed() {
        ...
        alertDialogBuilder = new AlertDialog.Builder(GoogleMapsActivity.this);

        //alertDialogBuilder.setIcon();
        //alertDialogBuilder.setTitle();
        alertDialogBuilder.setMessage("Sure to exit?");
    ...
    private String getUrl(double latitide, double longitude, String nearbyPlace) {
        ...
        googleURL.append("&key=" + "AIzaSyDM7MRyZQ6zKsh1pPe5xbHNa6Vi7nTzaH4");
